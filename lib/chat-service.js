...
- シンプルLP制作: 個人事業主・一人親方・小規模事業者向け。お客様から原稿と写真をご提供いただく1ページ構成は19,800円から。独自ドメイン取得・接続、Google Business Profileの初期整備、基本SEO、AI検索を意識した情報整理、HTTPSなどの基本確認、スマートフォン対応を相談できる。
