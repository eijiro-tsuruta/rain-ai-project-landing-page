...
- サービス: LP制作、投稿システム、AI更新・SNS連携、業務自動化・AIエージェント導入、AIチャットボット開発、Instagram自動投稿AI、LINE自動予約システム、Rain Field、Rain Recruit、AI導入・業務整理相談。
- LP制作の公式URLは https://www.rainaiproject.com/lp-production 。店舗LP、投稿できるLP、ズボラLPの3プランがあり、すべて写真・ロゴ・基本情報はお客様支給。写真撮影は含まない。
- 店舗LP: 50,000円（税別）の買い切りで月額なし。選択式デザインの1ページ、スマートフォン対応、SNS・LINE・電話への導線、写真のWeb用加工、基本SEO・AEO設定、公開前修正1回を含む。予約、管理画面、公開後の更新は含まない。
- 投稿できるLP: 初期50,000円から、月額9,800円（税別）。管理者ログイン、写真・文章による施工事例やお知らせの投稿・修正、画像の自動圧縮、保存、バックアップ、システム保守を含む。AIは文章を作らず、LP本体の固定写真・文章変更は別料金。
- ズボラLP: 初期98,000円から、月額29,800円（税別）。写真と一言メモからAIがタイトル、本文、写真説明、SNS文章を作り、確認後にLPへ公開し、BufferへSNS予約投稿する。外部サービスの料金はお客様負担。
- LP公開後の都度対応: 写真・文章差し替え5,500円から、セクション追加11,000円から、ページ追加22,000円から（すべて税別）。検索順位、AI検索での引用、問い合わせ数は保証しない。
...
- LP制作への追加機能: LINE予約Botは初期98,000円から・月額14,800円から、シナリオ型案内Botは初期55,000円から・月額9,900円から、生成AIチャットBotは初期150,000円から・月額29,800円から（すべて税別）。正式な構成は導入内容を確認して見積もる。
...
- LINE予約Botの標準導入: 初期98,000円、月額14,800円から（いずれも税別）。1店舗・3メニュー程度、アカウント取得支援、Googleカレンダー連携、基本メッセージ、予約・キャンセル動作確認、稼働監視、軽微な設定変更を含む。
- LINE予約Botの運用支援付き: 初期148,000円、月額29,800円から（いずれも税別）。標準導入の内容に加え、メニューや営業日の登録支援、予約条件の調整、運用中の変更対応を含む。複雑な担当者・設備・複数店舗管理は個別見積もり。
...
- シナリオ型案内Bot: 初期55,000円、月額9,900円から（いずれも税別）。選択肢や定型回答を使い、問い合わせ先や予約先へ案内する。生成AIによる自由文回答は含まない。
- ホームページAIチャットボットの標準導入: 初期150,000円、月額29,800円から（いずれも税別）。ホームページ1サイトの情報整理、自由文回答、回答範囲・禁止事項、想定質問による答え合わせ、基本デザイン調整、サイト設置、初期動作確認を含む。
...
1. シナリオ型案内Bot: 初期55,000円、月額9,900円から。選択肢や定型回答で問い合わせ・予約へ案内する。
2. ホームページAIチャットボット: 初期150,000円、月額29,800円から。ホームページ1サイトの情報整理、回答ルール、自由文回答、初期テスト、基本デザイン、サイト設置を想定。
3. PDF・FAQ・専門資料の追加: 初期33,000円から。資料量と答え合わせの範囲に応じて見積もる。
4. BIO型・業界特化型の専門AI: 完全個別見積もり。専門知識、独自評価、計算処理、専用画面などを含み、内容によって数百万円規模となる場合がある。
...
- LP制作は店舗LP50,000円買い切り、投稿できるLPは初期50,000円から・月額9,800円、ズボラLPは初期98,000円から・月額29,800円（すべて税別）。写真・ロゴ・基本情報はお客様支給で、撮影は含まない。追加作業や制作期間を推測せず、公式URLを尋ねられた場合は省略せずに案内する。
