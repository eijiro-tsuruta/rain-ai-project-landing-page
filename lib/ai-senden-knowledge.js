...
const AI_SENDEN_KNOWLEDGE = [
  {
    ...
    content: [
      ...
      "アプリは https://ai-senden.rainaiproject.com/ 、新規登録は https://ai-senden.rainaiproject.com/register です。",
  ...
  },
  {
    ...
    source: "取扱説明書 03 Instagram連携・08 よくある質問",
  ...
  },
  {
    ...
    source: "取扱説明書 06 使い方・07 処理中の注意・08 よくある質問",
  ...
  },
  {
    ...
    source: "取扱説明書 09 ホーム画面に追加",
    keywords: ["PWA", "ホーム画面", "アプリのように", "App Store", "インストール", "Chrome", "Safari", "共有ボタン", "アイコン", "追加"],
    content: [
      "AI宣伝しとけはPWAとしてホーム画面へ追加でき、App Storeからのインストールは不要です。",
