...
const AI_SENDEN_KNOWLEDGE = [
  ...
  },
  {
    ...
    keywords: ["Instagramと連携", "Meta", "許可", "連携済み", "ユーザーネーム", "別アカウント", "アカウントを切り替える", "Instagramアプリでログイン", "投稿先ID", "何の情報", "ログイン情報"],
    content: [
      "1. 連携前にブラウザでInstagramを開き、実際に投稿したい投稿先IDでログインします。別のIDでログイン中ならInstagram側でログアウトしてから切り替えます。",
      "2. AI宣伝しとけへ戻り、「Instagramと連携」を押します。",
      "3. 「Instagramで投稿先IDを確認」を必ず押し、Instagram側のIDを確認します。",
      "4. 認可画面に表示されたIDが投稿先と一致する場合だけ「許可」を押します。認可画面内のアカウント切り替えは使用しません。",
      "5. IDが違う場合は認可画面を閉じ、ブラウザのInstagramで投稿先IDへログインし直してから再連携します。",
      "6. AI宣伝しとけへ戻り、正しい投稿先IDと「連携済み」が表示されれば完了です。",
    ].join("\n"),
  },
  {
